...
defmodule Test.ParseDpkgTest do
  ...
  test "loading a simple package.json file results in the package being added to the monitor" do
    ...
    [
     ...
     %{"name" => "binutils",   "raw_version" => "2.24-5ubuntu3",                 "version" => "2.24.*"},
     %{"name" => "blueman",    "raw_version" => "1.23-git201403102151-1ubuntu1", "version" => "1.23.*"},
     %{"name" => "bluez",      "raw_version" => "4.101-0ubuntu13",               "version" => "4.101.*"},
